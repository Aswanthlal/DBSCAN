...
#Data generation
# The function below will generate the data points and requiresd inputs:
...
#createDataPoints with the3 inputs and store the output into variables X and y
...
#DBSCAN is especially very good for tasks like class identification in a spatial context. 
...
#clustering of ststions based on location
from sklearn.cluster import DBSCAN
